...
export default {
  ...
  SIGNIN_HEADING: "Continue With BuildIt",
  SIGNIN_SUBHEADING:
    "To use BuildIt you must log into an existing account or create one.",
  SIGNIn_AGREEMENT_TEXT:
    "By using BuildIt, you agree to the collection of usage data for analytics.",
